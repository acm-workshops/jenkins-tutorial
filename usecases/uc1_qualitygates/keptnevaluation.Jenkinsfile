...
node {
    properties([
        parameters([
         string(defaultValue: 'qualitygateproject', description: 'Name of your Project for Quality Gate Feedback ', name: 'Project', trim: false), 
    ...
    stage('Initialize Keptn') {
        ...
        keptn.downloadFile("https://raw.githubusercontent.com/acm-workshops/jenkins-tutorial/master/usecases/uc1_qualitygates/keptn/dynatrace/dynatrace.conf.yaml", 'keptn/dynatrace/dynatrace.conf.yaml')
        keptn.downloadFile("https://raw.githubusercontent.com/acm-workshops/jenkins-tutorial/master/usecases/uc1_qualitygates/keptn/slo_${params.SLI}.yaml", 'keptn/slo.yaml')
        keptn.downloadFile("https://raw.githubusercontent.com/acm-workshops/jenkins-tutorial/master/usecases/uc1_qualitygates/keptn/dynatrace/sli_${params.SLI}.yaml", 'keptn/sli.yaml')
